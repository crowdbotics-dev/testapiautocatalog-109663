...
## Project Structure
    ...
    ├── testapiautocatalog_109663  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_109663`
...
2. Clone this repo and `cd testapiautocatalog_109663`
